 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-card__slider")) new core(".slider-card__slider", {
            ...
            if (document.querySelector(".slider-card__sliders")) new core(".slider-card__sliders", {
                modules: [ Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.33,
            ...
            if (document.querySelector(".slider-card__slider-join")) new core(".slider-card__slider-join", {
        ...
        function headerScrollSecond() {
            addWindowScrollEvent = true;
            const headerSecond = document.querySelector("header.header_second");
            const headerShowSecond = headerSecond.hasAttribute("data-scroll-show-second");
            const headerShowTimerSecond = headerSecond.dataset.scrollShow ? headerSecond.dataset.scrollShow : 500;
            const startPointSecond = headerSecond.dataset.scroll ? headerSecond.dataset.scroll : 1;
            let scrollDirection = 0;
            let timer;
            document.addEventListener("windowScroll", (function(e) {
                const scrollTop = window.scrollY;
                clearTimeout(timer);
                if (scrollTop >= startPointSecond) {
                    !headerSecond.classList.contains("_header-scroll-second") ? headerSecond.classList.add("_header-scroll-second") : null;
                    if (headerShowSecond) {
                        if (scrollTop > scrollDirection) headerSecond.classList.contains("_header-show-second") ? headerSecond.classList.remove("_header-show-second") : null; else !headerSecond.classList.contains("_header-show-second") ? headerSecond.classList.add("_header-show-second") : null;
                        timer = setTimeout((() => {
                            !headerSecond.classList.contains("_header-show-second") ? headerSecond.classList.add("_header-show-second") : null;
                        }), headerShowTimerSecond);
                    }
                } else {
                    headerSecond.classList.contains("_header-scroll-second") ? headerSecond.classList.remove("_header-scroll-second") : null;
                    if (headerShowSecond) headerSecond.classList.contains("_header-show-second") ? headerSecond.classList.remove("_header-show-second") : null;
                }
                scrollDirection = scrollTop <= 0 ? 0 : scrollTop;
            }));
        }
            ...
            galleries.forEach((gallery => {
                galleryItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        ...
                        speed: 600,
                        selector: ".gallery-items__image-ibg"
                    })
                });
            }));
