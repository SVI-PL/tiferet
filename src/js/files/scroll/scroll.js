...
// Работа с шапкой при скроле в header-main.htm
...
// ==============================================================
// Работа с шапкой при скроле в header.htm
export function headerScrollSecond() {
	addWindowScrollEvent = true;
	...
	document.addEventListener("windowScroll", function (e) {
		...
		if (scrollTop >= startPointSecond) {
			...
			if (headerShowSecond) {
				if (scrollTop > scrollDirection) {
					// downscroll code
					headerSecond.classList.contains('_header-show-second') ? headerSecond.classList.remove('_header-show-second') : null;
				} else {
					// upscroll code
